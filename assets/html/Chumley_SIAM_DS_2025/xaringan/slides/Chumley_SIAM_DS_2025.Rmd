...
# Leveraging Differentiation of Persistence Diagrams for Biological Parameter Space Optimization

### **Max Chumley** <br> &mdash; <br> Mechanical Engineering<br><br>Computational Mathematics<br>Science and Engineering<br> &mdash;<br>Date: 5-13-25
...
![:img 45%, 43%, 29%](../figs/goodwin_path_anim.gif)


---
# Acknowledgements 

![:img 70%, 15%, 30%](../../people/people_tada.png)
...
![:img 90%, 5%, 30%](../figs/par_diff/goodwin1.png)

.footnote[Goodwin, B. C. (1965). Oscillatory behavior in enzymatic control processes. Advances in enzyme regulation, 3, 425-437.]

--
![:img 90%, 5%, 30%](../figs/par_diff/goodwin2.png)
--
![:img 90%, 5%, 30%](../figs/par_diff/goodwin3.png)


---
# Goodwin Example 1 (Fixed Point $\to$ Limit Cycle)

![:img 90%, 5%, 30%](../figs/par_diff/goodwin_path_decay_initial.png)
--
![:img 90%, 5%, 30%](../figs/par_diff/goodwin_path_decay.gif)
--
![:img 90%, 5%, 30%](../figs/par_diff/goodwin_path_decay_final.png)


---
# Goodwin Example 2 (Avoid Regions)

![:img 90%, 5%, 30%](../figs/par_diff/goodwin_avoid_decay_initial.png)
--
![:img 90%, 5%, 30%](../figs/par_diff/goodwin_avoid_decay.gif)
--
![:img 90%, 5%, 30%](../figs/par_diff/goodwin_avoid_decay_final.png)


---
# Potential future applications

![:img 90%, 5%, 30%](../figs/other_apps1.png)

.footnote[1. Novák, B., & Tyson, J. J. (2008). Design principles of biochemical oscillators. Nature reviews Molecular cell biology, 9(12), 981-991.

2. **Chumley, M. M.**, Khasawneh, F. A., Otto, A., & Gedeon, T. (2023). A Nonlinear Delay Model for Metabolic Oscillations in Yeast Cells. Bulletin of mathematical biology, 85(12), 122.]

--
![:img 90%, 5%, 30%](../figs/other_apps2.png)

![:img 20%, 40%, 45%](../figs/proteins.gif)

--
![:img 90%, 5%, 30%](../figs/other_apps3.png)
...
.footnote[**Chumley, Max M.**, and Firas A. Khasawneh. "Dynamical System Parameter Path Optimization using Persistent Homology." arXiv preprint arXiv:2505.00782 (2025).]
